        ...
        <div className="p-8 rounded-2xl border border-hairline bg-[var(--background-soft)] card-vercel-shadow">
          <div className="text-center mb-8">
            ...
            <p className="text-xs text-neutral-500 mt-1">
              Access your workspace, claimed domains, and AI visibility reports.
            </p>
          </div>
          ...
          <div className="relative my-6 text-center">
            ...
            <span className="relative bg-[var(--background-soft)] px-2 text-[10px] uppercase text-neutral-400">or log in with email</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 font-mono text-xs">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <a href="#" className="text-[11px] text-neutral-400 hover:text-neutral-900 dark:hover:text-white">Forgot?</a>
              </div>
              <input
                type="password"
                required
